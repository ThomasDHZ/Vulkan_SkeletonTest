...
public:
    ...
    Mesh(VulkanEngine& renderer, VkDescriptorSetLayout desc, Texture textureManager, const MeshData& meshData);
    Mesh(VulkanEngine& renderer, VkDescriptorSetLayout desc, Texture textureManager, const std::vector<Vertex>& vertexdata, const std::vector<uint16_t>& indicesdata, MeshTextures textures);
    Mesh(VulkanEngine& renderer, VkDescriptorSetLayout desc, Texture textureManager, const std::vector<Vertex>& vertexdata, const std::vector<uint16_t>& indicesdata, MeshTextures textures, CustomBuffer customBuffer);
    ~Mesh();
    ...
    virtual void ScreenResizeUpdate(VulkanEngine& renderer, VkDescriptorSetLayout desc, Texture textureManager);
