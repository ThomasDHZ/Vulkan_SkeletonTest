...
RenderedGBufferNormalTexture::RenderedGBufferNormalTexture(VulkanEngine& renderer) : Texture(renderer, TextureType::vkRenderedTexture)
{
...
void RenderedGBufferNormalTexture::CreateTextureImage(VulkanEngine& renderer)
{
...
void RenderedGBufferNormalTexture::CreateTextureView(VulkanEngine& renderer)
{
...
void RenderedGBufferNormalTexture::CreateTextureSampler(VulkanEngine& renderer)
{
...
void RenderedGBufferNormalTexture::RecreateRendererTexture(VulkanEngine& renderer)
{
