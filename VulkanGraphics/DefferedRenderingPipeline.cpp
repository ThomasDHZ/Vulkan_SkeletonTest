...
DefferedRenderingPipeline::DefferedRenderingPipeline() : GraphicsPipeline()
{
}

DefferedRenderingPipeline::DefferedRenderingPipeline(VulkanEngine& renderer, const VkRenderPass& renderPass) : GraphicsPipeline(renderer)
{
...
void DefferedRenderingPipeline::CreateDescriptorSetLayout(VulkanEngine& renderer)
{
...
void DefferedRenderingPipeline::CreateShaderPipeLine(VulkanEngine& renderer, const VkRenderPass& renderPass)
{
    ...
    std::array<VkPipelineColorBlendAttachmentState, 3> ColorAttachment = {};
...
void DefferedRenderingPipeline::UpdateGraphicsPipeLine(VulkanEngine& renderer, const VkRenderPass& renderPass)
{
