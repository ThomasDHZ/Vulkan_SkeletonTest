...
void Model::readNodeHierarchy(float p_animation_time, const aiNode* p_node, const aiMatrix4x4 parent_transform)
{
	...
	if (node_anim)
	{
		...
		std::cout << "Scale: Bone Name: " << node_name << " Frame: " << frame << std::endl;
		...
		std::cout << "Rotate: Bone Name: " << node_name << " Frame: " << frame << std::endl;
		...
		std::cout << "Translate: Bone Name: " << node_name << " Frame: " << frame << std::endl;
		...
		auto glmTransform = aiToGlm(node_transform);
		std::cout << "Bone Name: " << node_name << " Frame: " << frame << std::endl;
