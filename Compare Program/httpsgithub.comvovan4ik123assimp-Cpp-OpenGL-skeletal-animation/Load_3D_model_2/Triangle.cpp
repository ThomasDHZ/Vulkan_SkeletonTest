...
void Triangle::update()
{
	...
	glm::mat4 text_translate_to_model_2 = glm::translate(glm::mat4(), glm::vec3(matr_model_1[3].x, matr_model_1[3].y + 7.0f, matr_model_1[3].z));
	text_matrix_3D_model_2 = perspective_projection * perspective_view * text_translate_to_model_1 * text_rotate_y * text_rotate_x * set_text_to_origin * scale;
